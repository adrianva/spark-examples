...
sporting = sqlContext.sql("select equipoLocal, count(distinct(temporada))"
                                    " from partidos "
                                    " where equipoLocal='Sporting de Gijon'"
                                    " group by equipoLocal"
                                    )

oviedo = sqlContext.sql("select equipoLocal, count(distinct(temporada))"
                                    " from partidos"
